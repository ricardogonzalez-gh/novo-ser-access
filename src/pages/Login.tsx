      ...
      <Card className="relative z-10 w-full max-w-md shadow-lg rounded-2xl p-10 border-[#f0f0f0] bg-white">
        ...
        <CardContent className="space-y-6">
          <Button
            ...
            className="w-full gap-3 bg-white border border-[#f0f0f0] text-foreground shadow-sm hover:shadow-md hover:scale-[1.02] hover:bg-white transition-all duration-200 h-12"
            size="lg"
            variant="outline"
          >
